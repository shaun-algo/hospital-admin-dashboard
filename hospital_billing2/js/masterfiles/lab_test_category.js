  ...
  setupEventListeners() {
    ...
    if (tbody) {
      tbody.addEventListener('click', (e) => {
        ...
        const category = this.categoriesData.find(c => c.labtestcatid == id);
  ...
  renderCategoriesTable() {
    ...
    tbody.innerHTML = this.categoriesData.map(category => `
      <tr>
        ...
        <td>
          <button class="btn btn-sm btn-outline-info me-1" data-id="${category.labtestcatid}" data-action="view"><i class="bi bi-eye"></i></button>
          <button class="btn btn-sm btn-outline-warning me-1" data-id="${category.labtestcatid}" data-action="edit"><i class="bi bi-pencil"></i></button>
          <button class="btn btn-sm btn-outline-danger" data-id="${category.labtestcatid}" data-action="delete"><i class="bi bi-trash"></i></button>
        </td>
      </tr>
    `).join('');
  }
              ...
              <div class="modal-body">
                <form id="categoryForm" novalidate>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="categoryName" class="form-label"><i class="bi bi-tag me-1"></i>Category Name</label>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="handlingFee" class="form-label"><i class="bi bi-currency-dollar me-1"></i>Handling Fee</label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="turnaroundDays" class="form-label"><i class="bi bi-calendar-check me-1"></i>Turnaround Days</label>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="categoryDescription" class="form-label"><i class="bi bi-text-paragraph me-1"></i>Description</label>
